          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-700 rounded-lg bg-gray-800 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-gray-900">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ...
                    : 'block py-2 px-3 text-gray-100 hover:bg-gray-700 md:hover:bg-transparent md:hover:text-blue-700 md:p-0'
                }
              >
                Home
              </NavLink>
            ...
            <li>
              <NavLink
                ...
                className="block py-2 px-3 text-gray-100 hover:bg-gray-700 md:hover:bg-transparent md:hover:text-red-500 md:p-0"
              >
                Disconnect
              </NavLink>
            </li>
