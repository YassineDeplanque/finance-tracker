      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="bg-slate-800/70 shadow-lg rounded-2xl p-6 border border-slate-700">
          ...
          <div className="flex items-center justify-between mb-4">
            <select
              className="border border-slate-600 rounded-md p-2 bg-slate-900/70 text-slate-100"
          ...
          <ul className="space-y-2 max-h-80 overflow-y-auto">
            {income.map((i) => (
              <li
                key={i.id}
                className="flex flex-col gap-3 bg-slate-900/60 shadow rounded-lg p-3 border border-slate-700"
              >
